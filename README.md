...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-09 16:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a4c2399f-9579-4d8a-90f4-1db438f96bdc.git
$ cd a4c2399f-9579-4d8a-90f4-1db438f96bdc
```
